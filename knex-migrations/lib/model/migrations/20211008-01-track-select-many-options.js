...
const { getSelectMultipleResponses } = require('../../../../lib/data/submission'); // eslint-disable-line no-restricted-modules
const { Form } = require('../../../../lib/model/frames'); // eslint-disable-line no-restricted-modules
const { construct } = require('../../../../lib/util/util'); // eslint-disable-line no-restricted-modules
