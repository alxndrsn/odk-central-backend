...
inner join
  (select forms.id from forms
    ...
    inner join
      ...
      on assignment."acteeId" in (${sqlSpecial['*']}, ${sqlSpecial['form']}, projects."acteeId", forms."acteeId")
...
inner join
  (select id, max(assignment."showDraft") as "showDraft", max(assignment."showNonOpen") as "showNonOpen" from projects
    inner join
      ...
      on assignment."acteeId" in (${sqlSpecial['*']}, ${sqlSpecial['project']}, projects."acteeId")
