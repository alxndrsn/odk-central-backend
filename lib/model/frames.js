...
const { Frame, table, autogenerated, readable, writable, aux, species, embedded, fieldTypes } = require('./frame');
...
const Actor = Frame.define(
  table('actors'),
  'id',        readable, autogenerated, 'type',         readable,
...
class Audit extends Frame.define(
  ...
  'id',    autogenerated,               'actorId',      readable,
...
const Project = Frame.define(
  table('projects'),
  'id',          readable, autogenerated, 'name',         readable, writable,
