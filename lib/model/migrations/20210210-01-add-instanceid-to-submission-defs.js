...
module.exports = {
  up: async (db) => {
    await db.raw(`alter table "submission_defs" add column "instanceId" varchar(64)`);
    await db.raw(`create index "submission_defs_submissionid_instanceid_index" on "submission_defs" ("submissionId", "instanceId")`);
    await db.raw(`
