...
module.exports = {
  ...
  up: async (db) => {
    ...
    await db.raw(`select "id" from "roles" where "system" = $1`, 'initbkup');
    ...
    await db.raw(`DELETE FROM assignments WHERE "roleId" = $1`, '4');
    await db.raw(`DELETE FROM roles WHERE id = $1`, '4');
  },
};
