...
module.exports = {
  ...
  up: async (db) => {
    ...
    await db.raw(`select "verbs" from "roles" where "system" = $1`, 'viewer');
    await db.raw(`update "roles" set "verbs" = $1 where "system" = $2`, '["project.read", "form.list", "form.read", "submission.read", "submission.list", "dataset.list", "entity.list"]', 'viewer');
  },
};
