...
module.exports = {
  ...
  up: async (db) => {
    await db.raw(`update actors set "displayName"=(select email from users where users."actorId"=actors.id) where "displayName" is null and type='user';`);
    ...
    await db.raw(`alter table "actors" alter column "displayName" set not null`);
  },
};
