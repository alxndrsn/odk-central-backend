...
module.exports = {
  ...
  up: async (db) => {
    ...
    await db.raw(`alter table "field_keys" add column "projectId" integer`);
    await db.raw(`alter table "field_keys" add constraint "field_keys_projectid_foreign" foreign key ("projectId") references "projects" ("id")`);
    await db.raw(`create index "field_keys_actorid_projectid_index" on "field_keys" ("actorId", "projectId")`);
    await db.raw(`
