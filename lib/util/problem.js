...
const problems = {
  user: {
    ...
    xmlConflict: problem(409.1, () => 'A submission already exists with this ID, but with different XML.'),
    ...
    attachmentConflict: problem(409.19, () => 'A submission attachment already exists with this ID, but with different data.'),
