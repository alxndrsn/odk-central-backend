...
// re-introducing cookie settings, one at a time
    response.cookie(SESSION_COOKIE, session.token, {
      ...
      sameSite: 'Strict', // TODO we can set this to Strict for non-OIDC logins.  If we want to set it to Strict for OIDC logins, we will have to do a second redirect
    });
