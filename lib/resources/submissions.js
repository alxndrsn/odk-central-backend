            ...
            return (deprecatedId != null)
              ...
              ? Submissions.getAnyDefByFormAndInstanceId(form.id, deprecatedId, draft)
                ...
                .then((deprecated) => ((deprecated.current !== true)
                  // (even if deprecated is not current, if it is still n-1 we should allow insert on it.
                  ...
                  ? Submissions.getAnyDefByFormAndInstanceId(form.id, partial.instanceId, draft)
                    .then((maybeUsurper) => {
                      ...
                      return SubmissionAttachments.insert(usurper, files);
                    })
              ...
              : Submissions.getAnyDefByFormAndInstanceId(form.id, partial.instanceId, draft)
                .then((maybeExtant) => {
                  ...
                  if (extant != null) {
                    ...
                    return SubmissionAttachments.insert(extant, files);
                  }
