      ...
      Submission.fromXml(request)
        .then((partial) => getForm(params, Forms, partial.def.version)
          ...
          .then((form) => {
            ...
            return Submissions.createNew(partial, form, query.deviceID, userAgent)
              .then(submission => {
                return Forms.getBinaryFields(form.def.id)
                  .then(binaryFields => {
                    return SubmissionAttachments.create(submission, form, binaryFields)
