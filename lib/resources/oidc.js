...
module.exports = (service, endpoint) => {
  ...
  service.get('/oidc/callback', endpoint.manual(async (container, _, req, res) => {
    try {
      ...
      // TODO this doesn't seem elegant.  Replacing endpoint.manual with endpoint.html would
      // be an obvious alternative to this, but will require some changes to error handling.
      return false; // need to return something != null so that finalize() doesn't break
    }
  }));
