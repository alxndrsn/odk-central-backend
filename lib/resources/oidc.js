  ...
  service.get('/oidc/login', async (req, res) => {
    try {
      ...
      console.log(`
        ...
        @ /oidc/login
        @
        @ Received next query param: ${JSON.stringify(next)}
        @
        @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      `);
  ...
  service.get('/oidc/callback', endpoint(async (container, {}, req, res) => {
    try {
      ...
      console.log(`
        ...
        @ /oidc/callback
        @
        @ Received next cookie: ${JSON.stringify(next)}
        @
        @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
      `);
...
function errorToFrontend(req, res, errorCode) {
  ...
  console.log('loginUrl.pathname:', loginUrl.pathname);
  console.log('loginUrl.hash:', loginUrl.hash);
  console.log('loginUrl.search:', loginUrl.search);
