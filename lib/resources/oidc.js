...
const { allowInsecureRequests, calculatePKCECodeChallenge, discovery, generators, randomPKCECodeVerifier, randomState } = require('openid-client');
...
module.exports = (service, endpoint) => {
  ...
  service.get('/oidc/login', endpoint.html(async ({ Sentry }, _, req, res) => {
    try {
      ...
      const code_challenge = calculatePKCECodeChallenge(code_verifier); // eslint-disable-line camelcase
