...
const HTTPS_ENABLED = false; // TODO derive this from config or etc. (config.default.env.domain?)
...
module.exports = (service, endpoint) => {
  ...
  service.get('/oidc/login', async (req, res) => {
    try {
      ...
      res.cookie(CODE_VERIFIER_COOKIE, code_verifier, { httpOnly:true, secure:HTTPS_ENABLED, sameSite:'Lax', path:'/v1/oidc/callback', maxAge:ONE_HOUR });
