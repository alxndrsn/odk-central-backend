...
const authHandler = ({ Sessions, Users, Auth, bcrypt }, context) => {
  ...
  // Basic Auth, which is allowed over HTTPS only:
    ...
    // TODO we're not going to be able to basic-auth web users.  Should we just set their
    // password to something unguessable?  Do these same users still have legitimate
    // reasons for accessing using BasicAuth?
