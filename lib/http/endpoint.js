...
const getRequestContext = (request) => ({
  ...
  url: request.url,
  get originalUrl() { return request.originalUrl; },
  set originalUrl(_) { throw new Error('Attempted to write originalUrl.  See: https://expressjs.com/en/api.html#req.originalUrl'); },
