...
const uuidFor = acteeId => {
  ...
  console.log('uuidFor()', acteeId, Object.prototype.hasOwnProperty.call(sqlSpecial, acteeId), sqlSpecial[acteeId]);
  let res;
  if (acteeId == null) res = null;
  else if (Object.prototype.hasOwnProperty.call(sqlSpecial, acteeId)) res = sqlSpecial[acteeId];
  else if (acteeId.length === 36) res = acteeId;
