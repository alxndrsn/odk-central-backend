...
const { Frame, table, autogenerated, readable, writable, into, aux, embedded } = require(appRoot + '/lib/model/frame');
  ...
  describe('definition', () => {
    ...
    describe('insertfields', () => {
      it('should note insert fields and list', () => {
        const Box = Frame.define('id', autogenerated, 'a', readable, writable, 'b', writable, 'c');
        Box.insertfields.should.eql([ 'a', 'b', 'c' ]);
        sql`${Box.insertlist}`.should.eql(sql`"a","b","c"`);
      });

      it('should not include arbitrary autogenerated fields', () => {
        const Box = Frame.define('id', autogenerated, 'a', readable, writable, 'b', autogenerated, 'c');
        Box.insertfields.should.eql([ 'a', 'c' ]);
        sql`${Box.insertlist}`.should.eql(sql`"a","c"`);
      });
    });
