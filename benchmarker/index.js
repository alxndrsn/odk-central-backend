...
const log = (...args) => console.log('[benchmarker]', ...args);
log.debug  = (...args) => false && log('DEBUG',  ...args);
log.error  = (...args) => true  && log('ERROR',  ...args);
log.report = (...args) => true  && log('REPORT', ...args);
